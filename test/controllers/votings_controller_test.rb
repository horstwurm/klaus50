...
class VotingsControllerTest < ActionController::TestCase
  ...
  test "should create voting" do
    assert_difference('Voting.count') do
      post :create, voting: { picture_id: @voting.picture_id, rating: @voting.rating, user_id: @voting.user_id }
    end
  ...
  test "should update voting" do
    patch :update, id: @voting, voting: { picture_id: @voting.picture_id, rating: @voting.rating, user_id: @voting.user_id }
    assert_redirected_to voting_path(assigns(:voting))
  end
